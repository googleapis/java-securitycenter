...
The Maven artifact coordinates (`com.google.cloud:google-cloud-securitycenter`) remain the same.
...
```Groovy
implementation 'com.google.cloud:google-cloud-securitycenter:2.18.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-securitycenter" % "2.18.0"
```
