...
public final class SecurityMarksOuterClass {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          + "3google/cloud/securitycenter/v1/security_marks.proto\022\036google.cloud.securitycent"
          + "er.v1\032\031google/api/resource.proto\032\034google/api/annotations.proto\"\325\004\n\r"
          + "SecurityMarks\022\014\n"
          + "\004name\030\001 \001(\t\022G\n"
          + "\005marks\030\002 \003(\01328.google.c"
          + "loud.securitycenter.v1.SecurityMarks.MarksEntry\022\026\n"
          ...
          + "assets/{asset}/securityMarks\022Norganizations/{organization}/sources/{source}/find"
          + "ings/{finding}/securityMarks\022-folders/{folder}/assets/{asset}/securityMarks\022/pro"
          + "jects/{project}/assets/{asset}/securityMarks\022Bfolders/{folder}/sources/{source}/"
          + "findings/{finding}/securityMarks\022Dprojec"
          + "ts/{project}/sources/{source}/findings/{finding}/securityMarksB\332\001\n"
